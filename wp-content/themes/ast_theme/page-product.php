...
<div style="height:100%; position: relative; margin-top: 200px;">
        <div class="row" id="parrent_c" style="height: 100%; min-height: 1100px;">
            <div class="col-sm-3" id="child_c" style="    padding: 0 15px;    position: absolute;    top:   0px;     width: 196px; height: 100%;">
...
<script>
    $(document).ready(function() {
        ...
        //console.log($("#parrent_c").outerHeight());
        //console.log(document.getElementById("parrent_c").offsetHeight);
       //$("#child_c").css("height", $("#parrent_c").outerHeight()-200);
    });
</script>
